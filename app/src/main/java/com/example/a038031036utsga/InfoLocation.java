package com.example.a038031036utsga;
...
public class InfoLocation extends AppCompatActivity implements com.example.a038031036utsga.FetchAddressTask.OnTaskCompleted {
    // Constants
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                switch (menuItem.getItemId()){
                    case R.id.search:
                        startActivity(new Intent(getApplicationContext()
                                , com.example.a038031036utsga.SearchLocation.class));
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (mTrackingLocation) {
                    new com.example.a038031036utsga.FetchAddressTask(InfoLocation.this, InfoLocation.this).execute(locationResult.getLastLocation());
                }
            }
        };
        return;
